...
const NavigationArea = ({ previousService, nextService }: NavigationAreaProps) => {
  return (
    <div className="porfolio-details__navigation-area pb-120 black-bg-3">
            ...
            <div className="row align-items-center">
              <div className="col-xl-4 col-lg-4 col-md-4 col-12">
                <div className="porfolio-details__navigation-content text-center text-md-start">
                  <Link href={previousService.path}>
                    <i className="fa-regular fa-arrow-left"></i>
                    <span>Previous</span>
                  </Link>
                  <h4>{previousService.title}</h4>
                </div>
              </div>
              <div className="col-xl-4 col-lg-4 col-md-4 col-12">
                <div className="porfolio-details__navigation-bar text-center">
                  <Link href="/service" aria-label="View all capabilities">
                    <span>
