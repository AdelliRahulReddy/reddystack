...
const page = getIntentLandingPage("how-much-does-a-website-cost-in-india");

if (!page) {
  throw new Error("Intent landing page data missing for website cost in India");
}

export const metadata = buildIntentLandingPageMetadata(page);

const WebsiteCostInIndiaPage = () => {
...
export default WebsiteCostInIndiaPage;
