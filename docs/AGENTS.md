...
Updated: 2026-09-25. This file takes precedence over older docs (`AGENT_SOURCE_RULES.md`, `CODEBASE.md`, context files) where they conflict. Runtime source takes precedence over all docs.
...
- Next.js 16 App Router (see the Next.js note in the root `AGENTS.md`), React 19, TypeScript, Sass, Bootstrap 5, GSAP. Build uses webpack (`next build --webpack`).
